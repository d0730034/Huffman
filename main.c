...
int main(int argc,char*argv[])
{
    ...
    int i = 0;
    struct CompressionNode *headDataCom=(struct CompressionNode *)malloc(sizeof(struct CompressionNode));
	//build the data structure you were using during your compression algorithm
